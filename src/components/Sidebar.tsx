...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex fixed left-0 top-0 h-screen w-[200px] z-40 flex-col justify-between px-6 py-8 bg-white">
      <div>
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                key={link.href}
                href={link.href}
                className={`text-base font-medium px-2 py-1 w-fit ${
                  isActive
      ...
      <footer className="text-xs text-gray-400">
        ...
        <p>Copyright Vishwas Paliwal © All rights reserved</p>
      </footer>
    </aside>
  );
}
